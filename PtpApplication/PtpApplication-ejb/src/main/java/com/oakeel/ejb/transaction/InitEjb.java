...
public class InitEjb implements InitEjbLocal, Serializable {
    ...
    public void InitDB() {
        ...
        em.persist(root);
        d1.setParentUuid(root.getUuid());
        d2.setParentUuid(root.getUuid());
        d3.setParentUuid(root.getUuid());
        d4.setParentUuid(root.getUuid());
        d5.setParentUuid(root.getUuid());
        ...
        UserEntity user1 = new UserEntity("孔融", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user2 = new UserEntity("屈原", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user3 = new UserEntity("李白", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user4 = new UserEntity("杜甫", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user5 = new UserEntity("白居易", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user6 = new UserEntity("刘禹锡", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user7 = new UserEntity("李商隐", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user8 = new UserEntity("杜牧", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user9 = new UserEntity("李贺", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user10 = new UserEntity("张九龄", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user11 = new UserEntity("刘禹锡", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user12 = new UserEntity("王之涣", "ttjc", CreateAccountModeEnum.用户名);
        UserEntity user13 = new UserEntity("孔融", "ttjc", CreateAccountModeEnum.用户名);
        em.persist(user1);
        em.persist(user2);
        em.persist(user3);
        em.persist(user4);
