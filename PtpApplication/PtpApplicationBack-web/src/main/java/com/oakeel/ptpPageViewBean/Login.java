...
public class Login implements Serializable {
    ...
    @Inject PtpApplicationBean ptpApplicationBean;
    ...
    public String log() {
        if(validateCode.getCode().equals(validateStr.toLowerCase()))
        {
            ...
            try {
                ...
                else if(backUserEaoLocal.validateUserByQQ(voucher, password)!=null)
                {
                    ptpSessionBean.setLogUser(backUserEaoLocal.validateUserByQQ(voucher, password));
                }
                return "main";
            } 
